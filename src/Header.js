...
function Header() {
  return (
    <div className="text-center header flex items-center p-1 pl-1  justify-between text-white bg-[#232f3e]">
      <img
      ...
      <div className="header_address text-left">
        ...
        <div className=" font-bold header_optionLineTwo">Select Your Address</div>
      </div>

     
      <div className="header_search pr-2 flex w-[50%] items-center bg-[#f1a644] rounded-md">
      <input className="header_searchInput mr-1 flex-1 h-[35px]" type="text" />
        {/* {logo} */}
      ...
      <div className="header_nav flex gap-5">
        <div className="header_option">
          ...
          <div className="header_optionLineTwo font-bold ">Account &amp; Lists</div>
        </div>
